...
Aft service door for crew and catering access with structural frame and operating mechanism interface.
...
```
UTCS-MI:CAD:AAA:52-22:DOOR:rev[X]
UTCS-MI:CAE:AAA:52-22:STRESS:rev[X]
UTCS-MI:DEL:AAA:52-22:CERT:rev[X]
```
