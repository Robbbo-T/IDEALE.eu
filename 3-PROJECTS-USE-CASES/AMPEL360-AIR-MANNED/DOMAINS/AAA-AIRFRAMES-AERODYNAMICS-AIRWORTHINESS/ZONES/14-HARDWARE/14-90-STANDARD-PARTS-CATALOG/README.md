...
This sub-zone contains all design, analysis, procurement, and certification artifacts for Standard Parts Catalog.

## Directory Structure

```
14-90-STANDARD-PARTS-CATALOG/
├─ DELs/                          # Deliveries
...
```
UTCS-MI:CAD:AAA:14-90:HARDWARE:rev[X]
UTCS-MI:DOC:AAA:14-90:SPEC:rev[X]
UTCS-MI:DEL:AAA:14-90:CERT:rev[X]
```
