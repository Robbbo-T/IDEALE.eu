...
This sub-zone contains all design, analysis, procurement, and certification artifacts for Clamps, Clips, and Ties.

## Directory Structure

```
14-60-CLAMPS-CLIPS-TIES/
├─ DELs/                          # Deliveries
...
```
UTCS-MI:CAD:AAA:14-60:HARDWARE:rev[X]
UTCS-MI:DOC:AAA:14-60:SPEC:rev[X]
UTCS-MI:DEL:AAA:14-60:CERT:rev[X]
```
