...
This sub-zone contains all design, analysis, procurement, and certification artifacts for Adhesives, Sealers, and Hardware.

## Directory Structure

```
14-80-ADHESIVES-SEALERS-HARDWARE/
├─ DELs/                          # Deliveries
...
```
UTCS-MI:CAD:AAA:14-80:HARDWARE:rev[X]
UTCS-MI:DOC:AAA:14-80:SPEC:rev[X]
UTCS-MI:DEL:AAA:14-80:CERT:rev[X]
```
