# 51-20-MATERIALS-METALLIC-FORMING — Metallic Materials and Forming Processes
...
The metallic materials and forming system establishes standards and procedures for:
- Material selection and specifications (aluminum, titanium, steel alloys)
- Material properties and allowables determination
- Forming processes (bending, rolling, stamping, hydroforming)
...
This sub-zone contains all standards, procedures, and certification artifacts for metallic materials selection, processing, forming, and quality assurance.

## Directory Structure

```
51-20-MATERIALS-METALLIC-FORMING/
├─ DELs/                          # Deliveries
...
```
UTCS-MI:DOC:AAA:51-20:METHODS:rev[X]
UTCS-MI:CAE:AAA:51-20:ANALYSIS:rev[X]
UTCS-MI:DEL:AAA:51-20:CERT:rev[X]
```
