...
The forward cargo structure encompasses the structural design and integration of forward cargo hold primary structure, bulkheads, and door interfaces.
...
```
UTCS-MI:CAD:AAA:50-20:CARGO:rev[X]
UTCS-MI:CAE:AAA:50-20:LOADS:rev[X]
UTCS-MI:DEL:AAA:50-20:CERT:rev[X]
```
