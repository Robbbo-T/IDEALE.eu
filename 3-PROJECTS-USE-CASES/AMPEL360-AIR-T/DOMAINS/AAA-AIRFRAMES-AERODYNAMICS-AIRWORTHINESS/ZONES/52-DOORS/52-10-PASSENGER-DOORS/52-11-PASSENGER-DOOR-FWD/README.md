...
Main forward passenger entry door with structural frame, operating mechanism interface, and evacuation slide provisions.
...
```
UTCS-MI:CAD:AAA:52-11:DOOR:rev[X]
