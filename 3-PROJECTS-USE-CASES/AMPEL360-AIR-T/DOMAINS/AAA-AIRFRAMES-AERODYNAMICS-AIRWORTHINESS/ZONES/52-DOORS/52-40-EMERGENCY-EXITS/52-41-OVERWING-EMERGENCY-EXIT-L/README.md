# 52-41 — Left Overwing Emergency Exit
...
Left overwing emergency exit with structural frame and quick-release mechanisms.
...
```
UTCS-MI:CAD:AAA:52-41:DOOR:rev[X]
UTCS-MI:CAE:AAA:52-41:STRESS:rev[X]
UTCS-MI:DEL:AAA:52-41:CERT:rev[X]
```
