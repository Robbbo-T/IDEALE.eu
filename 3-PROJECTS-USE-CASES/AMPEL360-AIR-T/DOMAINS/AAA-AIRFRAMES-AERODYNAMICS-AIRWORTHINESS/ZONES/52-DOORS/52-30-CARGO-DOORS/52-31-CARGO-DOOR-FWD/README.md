...
Forward cargo compartment door with structural frame, locking mechanisms, and pressure seals.
...
```
UTCS-MI:CAD:AAA:52-31:DOOR:rev[X]
UTCS-MI:CAE:AAA:52-31:STRESS:rev[X]
UTCS-MI:DEL:AAA:52-31:CERT:rev[X]
```
