# CAS/CSDB — S1000D authoring for 55-STABILIZERS/55-00
...
- **MAINTENANCE/55-55-00/** — Scheduled tasks, fault isolation
- **REPAIR/55-55-00/** — Repair schemes, damage assessment
- **IPD/55-55-00/** — Illustrated parts data
...
```
UTCS-MI:AAA:CAS:55-55-00:[ARTIFACT]:rev[X]
```
