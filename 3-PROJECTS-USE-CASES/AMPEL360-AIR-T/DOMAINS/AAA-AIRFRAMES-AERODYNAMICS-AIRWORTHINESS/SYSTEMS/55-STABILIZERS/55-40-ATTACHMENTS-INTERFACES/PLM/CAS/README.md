# CAS/CSDB — S1000D authoring for 55-STABILIZERS/55-40
...
- **MAINTENANCE/55-55-40/** — Scheduled tasks, fault isolation
- **REPAIR/55-55-40/** — Repair schemes, damage assessment
- **IPD/55-55-40/** — Illustrated parts data
...
```
UTCS-MI:AAA:CAS:55-55-40:[ARTIFACT]:rev[X]
```
