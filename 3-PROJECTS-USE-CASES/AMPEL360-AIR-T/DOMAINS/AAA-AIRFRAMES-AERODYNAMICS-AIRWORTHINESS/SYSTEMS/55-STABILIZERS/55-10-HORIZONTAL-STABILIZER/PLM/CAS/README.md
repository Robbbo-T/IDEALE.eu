# CAS/CSDB — S1000D authoring for 55-STABILIZERS/55-10
...
- **MAINTENANCE/55-55-10/** — Scheduled tasks, fault isolation
- **REPAIR/55-55-10/** — Repair schemes, damage assessment
- **IPD/55-55-10/** — Illustrated parts data
...
```
UTCS-MI:AAA:CAS:55-55-10:[ARTIFACT]:rev[X]
```
