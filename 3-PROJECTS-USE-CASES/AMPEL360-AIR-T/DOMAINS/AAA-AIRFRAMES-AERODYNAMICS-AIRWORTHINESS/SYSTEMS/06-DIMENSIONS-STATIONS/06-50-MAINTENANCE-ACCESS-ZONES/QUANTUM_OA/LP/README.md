...
This directory contains Linear programming for optimization problems with linear objectives and constraints.

## Purpose

The LP optimization approach is used to solve complex design and configuration problems within this sub-zone, including:
- Layout optimization
...
```
LP-[PROBLEM]-[DATE]-[VERSION].[ext]
```

Example: `LP-LAYOUT-OPT-20250127-v1.py`
