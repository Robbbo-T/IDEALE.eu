# 53-80-CROWN-AND-DORSAL-STRUCTURE — Crown and Dorsal Structure
...
Crown and Dorsal Structure structural components and systems.

## Scope

This sub-zone contains all design, analysis, manufacturing, and certification artifacts for the crown and dorsal structure.

## Directory Structure

```
53-80-CROWN-AND-DORSAL-STRUCTURE/
├─ DELs/                          # Deliveries
...
`UTCS-MI:AAA:53-80:{artifact-type}:{version}`
