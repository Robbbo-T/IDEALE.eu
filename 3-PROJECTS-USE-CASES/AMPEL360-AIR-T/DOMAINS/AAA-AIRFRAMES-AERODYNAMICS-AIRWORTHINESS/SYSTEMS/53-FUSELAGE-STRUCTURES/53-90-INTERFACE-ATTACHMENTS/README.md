# 53-90-INTERFACE-ATTACHMENTS — Interface Attachments
...
Interface Attachments structural components and systems.

## Scope

This sub-zone contains all design, analysis, manufacturing, and certification artifacts for the interface attachments.

## Directory Structure

```
53-90-INTERFACE-ATTACHMENTS/
├─ DELs/                          # Deliveries
...
`UTCS-MI:AAA:53-90:{artifact-type}:{version}`
