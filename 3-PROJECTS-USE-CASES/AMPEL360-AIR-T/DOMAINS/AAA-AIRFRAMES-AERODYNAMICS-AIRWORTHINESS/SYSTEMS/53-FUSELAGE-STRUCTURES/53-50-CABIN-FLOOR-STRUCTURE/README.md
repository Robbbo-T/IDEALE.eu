# 53-50-CABIN-FLOOR-STRUCTURE — Cabin Floor Structure
...
Cabin Floor Structure structural components and systems.

## Scope

This sub-zone contains all design, analysis, manufacturing, and certification artifacts for the cabin floor structure.

## Directory Structure

```
53-50-CABIN-FLOOR-STRUCTURE/
├─ DELs/                          # Deliveries
...
`UTCS-MI:AAA:53-50:{artifact-type}:{version}`
