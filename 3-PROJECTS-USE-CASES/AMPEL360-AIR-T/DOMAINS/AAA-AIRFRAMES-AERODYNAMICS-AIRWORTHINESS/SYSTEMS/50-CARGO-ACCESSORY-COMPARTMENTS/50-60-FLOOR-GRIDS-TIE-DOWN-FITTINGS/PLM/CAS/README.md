# CAS/CSDB — S1000D authoring for 50-CARGO-ACCESSORY-COMPARTMENTS/50-60
...
- **MAINTENANCE/50-50-60/** — Scheduled tasks, fault isolation
- **REPAIR/50-50-60/** — Repair schemes, damage assessment
- **IPD/50-50-60/** — Illustrated parts data
...
```
UTCS-MI:AAA:CAS:50-50-60:[ARTIFACT]:rev[X]
```
