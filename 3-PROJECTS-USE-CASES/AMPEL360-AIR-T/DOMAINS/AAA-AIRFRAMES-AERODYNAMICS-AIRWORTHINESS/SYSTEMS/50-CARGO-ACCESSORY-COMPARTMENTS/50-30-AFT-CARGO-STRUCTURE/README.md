...
The aft cargo structure encompasses the structural design and integration of aft cargo hold primary structure, bulkheads, and pressurization boundaries.
...
```
UTCS-MI:CAD:AAA:50-30:CARGO:rev[X]
UTCS-MI:CAE:AAA:50-30:LOADS:rev[X]
UTCS-MI:DEL:AAA:50-30:CERT:rev[X]
```
