# CAS/CSDB — S1000D authoring for 50-CARGO-ACCESSORY-COMPARTMENTS/50-70
...
- **MAINTENANCE/50-50-70/** — Scheduled tasks, fault isolation
- **REPAIR/50-50-70/** — Repair schemes, damage assessment
- **IPD/50-50-70/** — Illustrated parts data
...
```
UTCS-MI:AAA:CAS:50-50-70:[ARTIFACT]:rev[X]
```
