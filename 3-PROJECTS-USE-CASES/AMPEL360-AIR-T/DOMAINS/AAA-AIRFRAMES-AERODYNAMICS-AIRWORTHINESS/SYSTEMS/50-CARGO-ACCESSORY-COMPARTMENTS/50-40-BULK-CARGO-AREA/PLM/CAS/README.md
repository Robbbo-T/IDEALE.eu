# CAS/CSDB — S1000D authoring for 50-CARGO-ACCESSORY-COMPARTMENTS/50-40
...
- **MAINTENANCE/50-50-40/** — Scheduled tasks, fault isolation
- **REPAIR/50-50-40/** — Repair schemes, damage assessment
- **IPD/50-50-40/** — Illustrated parts data
...
```
UTCS-MI:AAA:CAS:50-50-40:[ARTIFACT]:rev[X]
```
