# CAS/CSDB — S1000D authoring for 50-CARGO-ACCESSORY-COMPARTMENTS/50-50
...
- **MAINTENANCE/50-50-50/** — Scheduled tasks, fault isolation
- **REPAIR/50-50-50/** — Repair schemes, damage assessment
- **IPD/50-50-50/** — Illustrated parts data
...
```
UTCS-MI:AAA:CAS:50-50-50:[ARTIFACT]:rev[X]
```
