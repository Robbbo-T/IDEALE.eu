# CAS/CSDB — S1000D authoring for 50-CARGO-ACCESSORY-COMPARTMENTS/50-10
...
- **MAINTENANCE/50-50-10/** — Scheduled tasks, fault isolation
- **REPAIR/50-50-10/** — Repair schemes, damage assessment
- **IPD/50-50-10/** — Illustrated parts data
...
```
UTCS-MI:AAA:CAS:50-50-10:[ARTIFACT]:rev[X]
```
