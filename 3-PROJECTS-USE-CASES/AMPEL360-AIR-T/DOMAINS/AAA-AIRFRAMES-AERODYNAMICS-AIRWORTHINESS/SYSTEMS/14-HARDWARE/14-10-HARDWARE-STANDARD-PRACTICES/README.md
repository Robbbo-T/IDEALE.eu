...
This sub-zone contains all design, analysis, procurement, and certification artifacts for Hardware Standard Practices.

## Directory Structure

```
14-10-HARDWARE-STANDARD-PRACTICES/
├─ DELs/                          # Deliveries
...
```
UTCS-MI:CAD:AAA:14-10:HARDWARE:rev[X]
UTCS-MI:DOC:AAA:14-10:SPEC:rev[X]
