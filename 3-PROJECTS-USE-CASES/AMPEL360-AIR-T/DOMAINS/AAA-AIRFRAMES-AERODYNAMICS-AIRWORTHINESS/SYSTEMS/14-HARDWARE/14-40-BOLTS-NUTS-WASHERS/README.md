...
This sub-zone contains all design, analysis, procurement, and certification artifacts for Bolts, Nuts, and Washers.

## Directory Structure

```
14-40-BOLTS-NUTS-WASHERS/
├─ DELs/                          # Deliveries
...
```
UTCS-MI:CAD:AAA:14-40:HARDWARE:rev[X]
UTCS-MI:DOC:AAA:14-40:SPEC:rev[X]
UTCS-MI:DEL:AAA:14-40:CERT:rev[X]
```
