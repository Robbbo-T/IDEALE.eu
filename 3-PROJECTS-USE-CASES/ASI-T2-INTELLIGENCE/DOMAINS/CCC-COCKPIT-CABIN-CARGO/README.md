...
This domain folder contains all technical documentation, models, and compliance evidence related to **Flight deck, passenger cabin, and cargo systems including seating, galleys, and cargo handling** for the ASI-T2-INTELLIGENCE platform.
...
**Example**:
```
UTCS-MI:CCC:CAD:BASELINE-GEOMETRY:rev[A]
```
