...
This domain folder contains all technical documentation, models, and compliance evidence related to **Data systems, AI/ML platforms, decision support, and information management** for the ASI-T2-INTELLIGENCE platform.
...
**Example**:
```
UTCS-MI:IIS:CAD:BASELINE-GEOMETRY:rev[A]
```
...
- **[MAP-IIS](../../MAP-SERVICES/MAP-IIS/)** — Domain orchestration service
