...
This domain folder contains all technical documentation, models, and compliance evidence related to **Avionics, flight instruments, digital displays, and electronic systems integration** for the ASI-T2-INTELLIGENCE platform.
...
```
UTCS-MI:EDI:{plm_type}:{artifact}:rev[X]
```

**Example**:
```
UTCS-MI:EDI:CAD:BASELINE-GEOMETRY:rev[A]
```
...
- **[MAP-EDI](../../MAP-SERVICES/MAP-EDI/)** — Domain orchestration service
