...
Ccc Cockpit Cabin Cargo documentation and artifacts

---

## Purpose

This folder is part of the **CCC** domain within the **AMPEL360-SPACE-T** project (Manned Space Vehicle Platform).


**Scope**: Ccc Cockpit Cabin Cargo documentation and artifacts
...
**Domain Owner**: CCC Integration Team
