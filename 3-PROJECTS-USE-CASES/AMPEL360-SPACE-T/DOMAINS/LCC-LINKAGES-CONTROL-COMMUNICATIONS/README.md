...
Lcc Linkages Control Communications documentation and artifacts

---

## Purpose

This folder is part of the **LCC** domain within the **AMPEL360-SPACE-T** project (Manned Space Vehicle Platform).


**Scope**: Lcc Linkages Control Communications documentation and artifacts
...
**Domain Owner**: LCC Integration Team
