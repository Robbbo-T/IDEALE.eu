...
Lib Logistics Inventory Blockchain documentation and artifacts

---

## Purpose

This folder is part of the **LIB** domain within the **AMPEL360-SPACE-T** project (Manned Space Vehicle Platform).


**Scope**: Lib Logistics Inventory Blockchain documentation and artifacts
...
**Domain Owner**: LIB Integration Team
