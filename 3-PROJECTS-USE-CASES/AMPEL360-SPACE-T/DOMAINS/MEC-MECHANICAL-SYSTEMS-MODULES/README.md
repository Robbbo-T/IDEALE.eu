...
Mec Mechanical Systems Modules documentation and artifacts

---

## Purpose

This folder is part of the **MEC** domain within the **AMPEL360-SPACE-T** project (Manned Space Vehicle Platform).


**Scope**: Mec Mechanical Systems Modules documentation and artifacts
...
**Domain Owner**: MEC Integration Team
